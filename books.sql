...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 11 2019 г., 13:30
...
--
ALTER TABLE `authors`
  ADD CONSTRAINT `authors_ibfk_1` FOREIGN KEY (`isbn`) REFERENCES `book` (`isbn`);
...
--
ALTER TABLE `purchases`
  ADD CONSTRAINT `purchases_ibfk_1` FOREIGN KEY (`isbn`) REFERENCES `book` (`isbn`),
